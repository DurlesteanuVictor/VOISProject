...
def update_booking_status(
    ...
    # Verificăm dacă utilizatorul are voie să acceseze această rezervare
    ...
    # ---------------------------------------------------------
    # VALIDARE FLUX PENTRU CLIENT (USER)
    # ---------------------------------------------------------
    if current_user.role == "user":
    ...
    # ---------------------------------------------------------
    # VALIDARE FLUX PENTRU COMPANIE (MECHANIC)
    # ---------------------------------------------------------
